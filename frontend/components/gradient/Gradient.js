...
const GradientDefault = props => {
  ...
  useEffect(() => {
    ...
    /* Display scene */
    myCanvas.current.appendChild( renderer.domElement )
    ...
    /* Manage color variation function */
    ...
    let material = new THREE.ShaderMaterial({
        uniforms: {
            u_bg: {type: 'v3', value: rgb(202, 169, 98)},
            u_bgMain: {type: 'v3', value: rgb(202, 169, 98)},
            u_color1: {type: 'v3', value: rgb(220, 155, 62)},
            u_color2: {type: 'v3', value: rgb(247, 243, 214)},
            u_time: {type: 'f', value: 1000},
            u_randomisePosition: { type: 'v2', value: rgb(202, 169, 98) }
        },
  ...
  return (
    <>
      <noscript id="snoise-function" type="x-shader/x-vertex" dangerouslySetInnerHTML={{__html: `
      ...
      <script id="vertex-shader" type="x-shader/x-vertex" dangerouslySetInnerHTML={{__html: `
      ...
      <noscript id="fragment-shader" type="x-shader/x-fragment" dangerouslySetInnerHTML={{__html: `
